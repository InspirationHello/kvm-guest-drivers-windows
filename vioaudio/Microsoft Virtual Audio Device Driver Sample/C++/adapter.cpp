...
#pragma warning (pop)
        ...
        PCSaveBackend backends[2] = { 0 }, saveBackend;

        backends[0] = new (NonPagedPool, MSVAD_POOLTAG)CVioSaveData(RegistryPathName);
        // backends[1] = new (NonPagedPool, MSVAD_POOLTAG)CTcpSaveData(RegistryPathName);
        backends[1] = new (NonPagedPool, MSVAD_POOLTAG)CSaveBackend(RegistryPathName);
